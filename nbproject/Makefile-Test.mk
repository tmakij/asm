...
${OBJECTDIR}/ASM_DYNAMIC.o: ASM_DYNAMIC.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_DYNAMIC.o ASM_DYNAMIC.c

${OBJECTDIR}/ASM_LEVENSHTEIN_OUTPUT.o: ASM_LEVENSHTEIN_OUTPUT.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_LEVENSHTEIN_OUTPUT.o ASM_LEVENSHTEIN_OUTPUT.c

${OBJECTDIR}/ASM_MYERS.o: ASM_MYERS.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_MYERS.o ASM_MYERS.c

${OBJECTDIR}/ASM_READ_FILE.o: ASM_READ_FILE.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_READ_FILE.o ASM_READ_FILE.c

${OBJECTDIR}/ASM_STRING.o: ASM_STRING.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_STRING.o ASM_STRING.c

${OBJECTDIR}/ASM_UKKONEN.o: ASM_UKKONEN.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_UKKONEN.o ASM_UKKONEN.c

${OBJECTDIR}/MIN.o: MIN.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MIN.o MIN.c

${OBJECTDIR}/Tests/PRECOMPUTED.o: Tests/PRECOMPUTED.c
	${MKDIR} -p ${OBJECTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tests/PRECOMPUTED.o Tests/PRECOMPUTED.c

${OBJECTDIR}/Tests/RANDOM_TEST.o: Tests/RANDOM_TEST.c
	${MKDIR} -p ${OBJECTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tests/RANDOM_TEST.o Tests/RANDOM_TEST.c

${OBJECTDIR}/main.o: main.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c
...
${TESTDIR}/tests/precomputed.o: tests/precomputed.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DASM_TEST -I. -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/precomputed.o tests/precomputed.c
...
${OBJECTDIR}/ASM_DYNAMIC_nomain.o: ${OBJECTDIR}/ASM_DYNAMIC.o ASM_DYNAMIC.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_DYNAMIC_nomain.o ASM_DYNAMIC.c;\
	else  \
...
${OBJECTDIR}/ASM_LEVENSHTEIN_OUTPUT_nomain.o: ${OBJECTDIR}/ASM_LEVENSHTEIN_OUTPUT.o ASM_LEVENSHTEIN_OUTPUT.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_LEVENSHTEIN_OUTPUT_nomain.o ASM_LEVENSHTEIN_OUTPUT.c;\
	else  \
...
${OBJECTDIR}/ASM_MYERS_nomain.o: ${OBJECTDIR}/ASM_MYERS.o ASM_MYERS.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_MYERS_nomain.o ASM_MYERS.c;\
	else  \
...
${OBJECTDIR}/ASM_READ_FILE_nomain.o: ${OBJECTDIR}/ASM_READ_FILE.o ASM_READ_FILE.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_READ_FILE_nomain.o ASM_READ_FILE.c;\
	else  \
...
${OBJECTDIR}/ASM_STRING_nomain.o: ${OBJECTDIR}/ASM_STRING.o ASM_STRING.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_STRING_nomain.o ASM_STRING.c;\
	else  \
...
${OBJECTDIR}/ASM_UKKONEN_nomain.o: ${OBJECTDIR}/ASM_UKKONEN.o ASM_UKKONEN.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ASM_UKKONEN_nomain.o ASM_UKKONEN.c;\
	else  \
...
${OBJECTDIR}/MIN_nomain.o: ${OBJECTDIR}/MIN.o MIN.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MIN_nomain.o MIN.c;\
	else  \
...
${OBJECTDIR}/Tests/PRECOMPUTED_nomain.o: ${OBJECTDIR}/Tests/PRECOMPUTED.o Tests/PRECOMPUTED.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tests/PRECOMPUTED_nomain.o Tests/PRECOMPUTED.c;\
	else  \
...
${OBJECTDIR}/Tests/RANDOM_TEST_nomain.o: ${OBJECTDIR}/Tests/RANDOM_TEST.o Tests/RANDOM_TEST.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tests/RANDOM_TEST_nomain.o Tests/RANDOM_TEST.c;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DASM_TEST -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.c;\
	else  \
